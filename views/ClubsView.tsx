    ...
    <div className="pt-20">
      <Section>
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-black uppercase text-white mb-6">Våre Klubber</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {clubs.map((club, idx) => (
                  <div key={idx} className="bg-[#121212] border border-[#1a1a1a] p-8 hover:border-[#e34b17] transition-colors group">
                      <MapPin className="text-[#e34b17] w-8 h-8 mb-6 group-hover:animate-bounce" />
                      <h2 className="text-xl font-bold text-white uppercase mb-2">{club.name}</h2>
                      <h3 className="text-[#e34b17] font-bold uppercase text-xs tracking-widest mb-4">{club.city}</h3>
