    ...
    <div className="pt-20">
      <Section darker className="min-h-screen">
        <div className="mb-12 text-center">
          <h1 className="text-5xl md:text-7xl font-black uppercase text-white mb-6 tracking-tight">
            Pensum
          </h1>
          ...
          <div className="flex justify-center mb-16">
              <div className="bg-[#1a1a1a] p-1 rounded-sm flex border border-[#333]">
                  <button
                    ...
                    className={`px-8 py-3 flex items-center gap-2 font-bold uppercase tracking-wider transition-all duration-300 ${
                        activeTab === 'barn' 
            ...
            {activeTab === 'barn' ? (
                <div className="space-y-4">
                    ...
                    {CURRICULUM_KIDS.map((item, idx) => (
                        ...
                        >
                            <span className="text-lg font-medium text-gray-200 group-hover:text-white uppercase tracking-wide text-left">
                                {item.label}
                            </span>
                    ...
                    {CURRICULUM_ADULTS.map((item, idx) => (
                        ...
                        >
                            <div className="text-left">
                                <span className="block text-lg font-medium text-gray-200 group-hover:text-white uppercase tracking-wide">
                                    {item.label}
                                </span>
                                {item.subLabel && (
                                    <span className="text-sm text-[#e34b17] font-bold mt-1 block">
                                        {item.subLabel}
                                    </span>
                                )}
                            </div>
