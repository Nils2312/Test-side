    ...
    <div className="pt-20">
      <Section className="min-h-screen">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-7xl font-black uppercase text-white tracking-tight">
            Våre Instruktører
          </h1>
        </div>
            ...
            <div key={instructor.id} className="group relative bg-[#121212] border border-[#1a1a1a] hover:border-[#e34b17] transition-all duration-500">
              ...
              <div className="p-8 relative">
                ...
                <div className="flex gap-2 mt-4">
                   {/* Decorative dots */}
                   <div className="w-2 h-2 bg-[#333] rounded-full group-hover:bg-[#e34b17] transition-colors delay-75" />
                   <div className="w-2 h-2 bg-[#333] rounded-full group-hover:bg-[#e34b17] transition-colors delay-150" />
                   <div className="w-2 h-2 bg-[#333] rounded-full group-hover:bg-[#e34b17] transition-colors delay-200" />
                </div>
              </div>
            </div>
          ))}
